...
namespace DarkControls.Controls
{
    ...
    public class IconButton : PictureBox
    {
        ...
        /// </summary>
        public IconButton()
            : this(IconType.Max, 16, Color.DimGray, Color.Black, false, null)
        {
        ...
        private IconType _iconType = IconType.Max;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            SizeF stringSize = graphics.MeasureString(IconChar, IconFont, new SizeF(Width,Height));
            ...
            graphics.DrawString(IconChar, IconFont, IconBrush, new RectangleF(new PointF(left, top),new SizeF(Width,h-2)));
        ...
        {
            IconFont = GetAdjustedFont(g, IconChar, Width-2, Height-4, 4, true);
        }
        ...
        {
            return new Font(Fonts.Families[0], size,Bold?FontStyle.Bold:FontStyle.Regular, GraphicsUnit.Point);
        }
            ...
            try
            {
               GCHandle hObject = GCHandle.Alloc(ResourceFont.iconfont, GCHandleType.Pinned);
                IntPtr intptr = hObject.AddrOfPinnedObject();
                        ...
                        uint dummy = 0;
                        Fonts.AddMemoryFont((IntPtr)intptr, ResourceFont.iconfont.Length);
                        AddFontMemResourceEx((IntPtr)intptr, (uint)ResourceFont.iconfont.Length, IntPtr.Zero, ref dummy);
